...
public class ConfigHUDScreen extends Screen {
    ...
    protected void init() {
        ...
        buttonWidget = ButtonWidget.builder(DRAG_TEXT, (button) -> {
        }).dimensions(buttonX, buttonY, 70, 15).build();
    ...
    private ButtonWidget doneButton() {
        return ButtonWidget.builder(CommonComponents.GUI_DONE, (button) -> this.minecraft.setScreen(this.parent)).dimensions(this.width / 2 - 100, this.height - 27, 200, 20).build();
    }
