...
public class DeBugScreen extends Screen {
    ...
    protected void init() {
        ...
        ButtonWidget done = ButtonWidget.builder(CommonComponents.GUI_DONE, (buttonWidget) -> this.minecraft.setScreen(this.parent)).dimensions(this.width / 2 - 100, this.height - 27, 200, 20).build();;
        this.addRenderableWidget(done);
        ButtonWidget save = ButtonWidget.builder(TRACKER_SAVE_TEXT, (button) -> ClassManager.saveToFile()).build();
        ...
        FrameLayout.alignInRectangle(gridWidget, 0, this.height / 6 - 12, this.width, this.height, 0.5F, 0.0F);
